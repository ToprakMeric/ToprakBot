...
public class ToprakBot
{
    static async Task<List<string>> TitleList()
    {
        ...
        string apiUrl = "https://tr.wikipedia.org/w/api.php?action=query&formatversion=2&list=recentchanges&rcdir=older&rcend=" + DateTime.Now.AddDays(-1).ToString("yyyy-MM-dd") + "T00:00:00.000Z&rclimit=max&rcnamespace=0&rcprop=title&rcstart=" + DateTime.Today.ToString("yyyy-MM-dd") + "T00:00:00.000Z&rctype=new&format=json";
