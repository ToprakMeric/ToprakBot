...
public class KaynakCevir {
    static string Tercuman(string eskiay) {
        string yeniay = "";
        if(eskiay.ToLower()=="january")
            yeniay="Ocak";
        else if(eskiay.ToLower()=="february")
            yeniay="Şubat";
        else if(eskiay.ToLower()=="march")
            yeniay="Mart";
        else if(eskiay.ToLower()=="april")
            yeniay="Nisan";
        else if(eskiay.ToLower()=="may")
            yeniay="Mayıs";
        else if(eskiay.ToLower()=="june")
            yeniay="Haziran";
        else if(eskiay.ToLower()=="july")
            yeniay="Temmuz";
        else if(eskiay.ToLower()=="august")
            yeniay="Ağustos";
        else if(eskiay.ToLower()=="september")
            yeniay="Eylül";
        else if(eskiay.ToLower()=="october")
            yeniay="Ekim";
        else if(eskiay.ToLower()=="november")
            yeniay="Kasım";
        else if(eskiay.ToLower()=="december")
            yeniay="Aralık";
